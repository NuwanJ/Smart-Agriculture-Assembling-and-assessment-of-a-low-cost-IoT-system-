...
void beginOTA() {
   ...
   while (WiFi.waitForConnectResult() != WL_CONNECTED) {
      ...
      errorReport(ERROR_OTA_WIFI_FAILED);
      delay(5000);
      ESP.restart();
   }
   ...
   ArduinoOTA.setPassword("2agri951");
   ...
   .onError([](ota_error_t error) {
      ...
      errorReport(ERROR_OTA_LOCAL_FAILED);
   });
   ...
   if (espClient.connect(host.c_str(), port)) {
      ...
      while (espClient.available() == 0) {
         if (millis() - timeout > 5000) {
            ...
            errorReport(ERROR_OTA_CLIENT_TIMEOUT);
   ...
   if (contentLength && isValidContentType) {
      ...
      if (canBegin) {
         ...
         if (written == contentLength) {
            ...
            errorReport(ERROR_OTA_REMOTE_UNSUCCESS);
         ...
         errorReport(ERROR_OTA_NO_ENOUGH_SPACE);
      ...
      errorReport(ERROR_OTA_NO_CONTENT);
